...
?>
<div class="span-24">
    <div class="primary story span-16">
		<div class="story-content">
<h3>Privacy Policy</h3>

<p>Last updated: September 16, 2015</p>

<p>The Express Tribune ("us", "we", or "our") operates the http://tribune.com.pk website (the "Service").</p>

<p>This page informs you of our policies regarding the collection, use and disclosure of Personal Information when you use our Service.</p>

<p>We will not use or share your information with anyone except as described in this Privacy Policy.</p>

<p><strong>We use your Personal Information for providing and improving the Service. By using the Service, you agree to the collection and use of information in accordance with this policy.</strong> Unless otherwise defined in this Privacy Policy, terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, accessible at http://tribune.com.pk</p>
...
<p>If you are located outside Pakistan and choose to provide information to us, please note that we transfer the information, including Personal Information, to Pakistan and process it there.</p>
...
<p>If you have any questions about this Privacy Policy, please contact us.</p>
    ...
    <div class="span-8 sidebar last">
        <!-- ADVERTISEMENT -->
        <?php exp_display_advertisement_widget(); ?>
    </div>
</div>
  <?php
get_footer();
