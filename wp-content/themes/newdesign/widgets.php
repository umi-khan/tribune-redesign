...
// Top Storie Widget
add_action("widgets_init", array('TopstoriesWidget','init') );
class TopstoriesWidget extends WP_Widget
{
    public function __construct()
    {
        $options = array( 'description' => 'Display Top Storie widgets.' );

        parent::__construct( 'TopstorieWidget', 'Top Stories', $options );
    }
      ...
      function widget($args, $instance)
    {
     ?>
        <div class="clearfix">
            <div class="span-8">
                <?php exp_load_widget_file( 'top-stories'); ?>
            </div>
          </div>        
<?php
    }
...
// Feature Storie Widget
add_action("widgets_init", array('FeaturestoriesWidget','init') );
class FeaturestoriesWidget extends WP_Widget
{
    public function __construct()
    {
        $options = array( 'description' => 'Display Feature Storie widgets.' );

        parent::__construct( 'FeaturestorieWidget', 'Feature Stories', $options );
    }
    
    public static function init()
    {
        register_widget( 'FeaturestoriesWidget' );
    }
      ...
      function widget($args, $instance)
    {
     ?>
        <div class="clearfix">
            <div class="span-8">
                <?php exp_load_widget_file( 'feature-stories'); ?>
            </div>
          </div>        
<?php
    }
...
// Videos Stories Widget
add_action("widgets_init", array('VideosstoriesWidget','init') );
class VideosstoriesWidget extends WP_Widget
{
    public function __construct()
    {
        $options = array( 'description' => 'Display Videos Stories widgets.' );

        parent::__construct( 'VideosstoriesWidget', 'Videos Stories ', $options );
    }
    
    public static function init()
    {
        register_widget( 'VideosstoriesWidget' );
    }
      ...
      function widget($args, $instance)
    {
     ?>
        <div class="clearfix">
            <div class="span-8">
                <?php exp_load_widget_file( 'video'); ?>
            </div>
          </div>        
<?php
    }
...
add_action("widgets_init", array('RecentgalleryWidget','init') );
class RecentgalleryWidget extends WP_Widget
{
    public function __construct()
    {
        $options = array( 'description' => 'Display Recent Gallery widgets.' );

        parent::__construct( 'RecentgalleryWidget', 'Recent Gallery', $options );
    }
    
    public static function init()
    {
        register_widget( 'RecentgalleryWidget' );
    }
      ...
      function widget($args, $instance)
    {
     ?>
        <div class="clearfix">
            <div class="span-8">
                <?php exp_load_widget_file( 'recent-gallery'); ?>
            </div>
          </div>        
<?php
    }
...
// Collective Categories Widget
add_action("widgets_init", array('CollectivecategoriesWidget','init') );
class CollectivecategoriesWidget extends WP_Widget
{
    public function __construct()
    {
        $options = array( 'description' => 'Display Collective Categories widgets.' );

        parent::__construct( 'VideoWidget', 'Collective Categories', $options );
    }
    
    public static function init()
    {
        register_widget( 'CollectivecategoriesWidget' );
    }
      ...
      function widget($args, $instance)
    {
     ?>
        <div class="clearfix">
            <div class="span-8">
                <?php exp_load_widget_file( 'collective-categories'); ?>
            </div>
          </div>        
<?php
    }
...
// Comment Stories Widget
add_action("widgets_init", array('CommentstoriesWidget','init') );
class CommentstoriesWidget extends WP_Widget
{
    public function __construct()
    {
        $options = array( 'description' => 'Display Comment Stories widgets.' );

        parent::__construct( 'CommentstoriesWidget', 'Comment Stories', $options );
    }
    
    public static function init()
    {
        register_widget( 'CommentstoriesWidget' );
    }
      ...
      function widget($args, $instance)
    {
     ?>
        <div class="clearfix">
            <div class="span-8">
                <?php exp_load_widget_file( 'comment-stories'); ?>
            </div>
          </div>        
<?php
    }
