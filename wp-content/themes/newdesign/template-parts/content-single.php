...
<div class="col-lg-12 stickybar"><div class="col-lg-7 last stickytitle"><h1 class="title"><span class="slogo"><a href="/" title="Tribune" style="background-image:url('<?php echo get_template_directory_uri().'/img/t.gif';?>');">&nbsp;</a></span> <?php echo $story->title; ?></h1>
</div><div class="col-lg-4 last stickyicons"><a href="#" class="ss-button facebook like-button share s_facebook"><span class="fb"></span>Share</a>
