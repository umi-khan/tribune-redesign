...
?>
		<div id="onestop" class="span-24 widget">
			...
			<div class="content clearfix">
				<div class="controls">
					<img src="<?php echo get_template_directory_uri() ?>/img/left-arrow-thin.gif" width="5" height="9" alt="&lt;" class="prev disabled" title="Previous" />
					<img src="<?php echo get_template_directory_uri() ?>/img/right-arrow-thin.gif" width="5" height="9" alt="&gt;" class="next" title="Next" />
				</div>
				<div class="carousel">					
